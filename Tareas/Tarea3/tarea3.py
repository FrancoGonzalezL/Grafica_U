...
def on_key_press(symbol, modifiers):
    ...
    if symbol == pyglet.window.key.W:
        nave.speed =  1
        ruta.actualizar([nave.positionX,nave.positionY,nave.positionZ],controller.total_time,[nave.theta])
        ruta.print()
    ...
    if symbol == pyglet.window.key.R:
        ruta.iniciar_grabacion([nave.positionX,nave.positionY,nave.positionZ],controller.total_time,[nave.theta])
        ruta.print()
